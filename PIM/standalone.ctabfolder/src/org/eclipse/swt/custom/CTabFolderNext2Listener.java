 ...
 * </p>
 *
 * @see CTabFolder2NextAdapter
 * @see CTabFolderNextEvent
 *
 * @since 3.0
 */
public interface CTabFolderNext2Listener extends SWTEventListener {
 ...
 *
 * @see CTabFolderNext#getMinimized()
 * @see CTabFolderNext#setMinimized(boolean)
 * @see CTabFolderNext#setMinimizeVisible(boolean)
 */
 ...
 *
 * @see CTabFolderNext#getMaximized()
 * @see CTabFolderNext#setMaximized(boolean)
 * @see CTabFolderNext#setMaximizeVisible(boolean)
 */
 ...
 *
 * @see CTabFolderNext#setSelection(CTabItem)
 */
public void showList(CTabFolderNextEvent event);

/**
 * Static helper method to create a <code>CTabFolder2Listener</code> for the
 * {@link #close(CTabFolderNextEvent e)}) method, given a lambda expression or a method reference.
 *
 * @param c the consumer of the event
 * @return CTabFolder2Listener
 * @since 3.107
 */
public static CTabFolderNext2Listener closeAdapter(Consumer<CTabFolderNextEvent> c) {
	return new CTabFolderNext2Adapter() {
		@Override
		public void close(CTabFolderNextEvent e) {
			c.accept(e);
		}
	};
}
...
/**
 * Static helper method to create a <code>CTabFolder2Listener</code> for the
 * {@link #minimize(CTabFolderNextEvent e)}) method, given a lambda expression or a method reference.
 *
 * @param c the consumer of the event
 * @return CTabFolder2Listener
 * @since 3.107
 */
public static CTabFolderNext2Listener minimizeAdapter(Consumer<CTabFolderNextEvent> c) {
	return new CTabFolderNext2Adapter() {
		@Override
		public void minimize(CTabFolderNextEvent e) {
			c.accept(e);
		}
	};
}
...
/**
 * Static helper method to create a <code>CTabFolder2Listener</code> for the
 * {@link #maximize(CTabFolderNextEvent e)}) method, given a lambda expression or a method reference.
 *
 * @param c the consumer of the event
 * @return CTabFolder2Listener
 * @since 3.107
 */
public static CTabFolderNext2Listener maximizeAdapter(Consumer<CTabFolderNextEvent> c) {
	return new CTabFolderNext2Adapter() {
		@Override
		public void maximize(CTabFolderNextEvent e) {
			c.accept(e);
		}
	};
}
...
/**
 * Static helper method to create a <code>CTabFolder2Listener</code> for the
 * {@link #restore(CTabFolderNextEvent e)}) method, given a lambda expression or a method reference.
 *
 * @param c the consumer of the event
 * @return CTabFolder2Listener
 * @since 3.107
 */
public static CTabFolderNext2Listener restoreAdapter(Consumer<CTabFolderNextEvent> c) {
	return new CTabFolderNext2Adapter() {
		@Override
		public void restore(CTabFolderNextEvent e) {
			c.accept(e);
		}
	};
}
...
/**
 * Static helper method to create a <code>CTabFolder2Listener</code> for the
 * {@link #showList(CTabFolderNextEvent e)}) method, given a lambda expression or a method reference.
 *
 * @param c the consumer of the event
 * @return CTabFolder2Listener
 * @since 3.107
 */
public static CTabFolderNext2Listener showListAdapter(Consumer<CTabFolderNextEvent> c) {
	return new CTabFolderNext2Adapter() {
		@Override
		public void showList(CTabFolderNextEvent e) {
			c.accept(e);
		}
	};
}
