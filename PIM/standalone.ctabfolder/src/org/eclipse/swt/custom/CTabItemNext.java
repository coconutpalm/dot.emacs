 ...
 */
public class CTabItemNext extends Item {
	CTabFolderNext parent;
 ...
 * @see Widget#getStyle()
 */
public CTabItemNext (CTabFolderNext parent, int style) {
 ...
 * @see Widget#getStyle()
 */
public CTabItemNext (CTabFolderNext parent, int style, int index) {
	super (parent, style);
 ...
 * </ul>
 */
public CTabFolderNext getParent () {
	/*
	 * This call is intentionally commented out, to allow this getter method to be
	 * called from a thread which is different from one that created the widget.
	 */
...
public void setFont (Font font){
	...
	this.font = font;
	parent.updateFolder(CTabFolderNext.UPDATE_TAB_HEIGHT | CTabFolderNext.REDRAW_TABS);
}
...
public void setForeground (Color color) {
	...
	foreground = color;
	parent.updateFolder(CTabFolderNext.REDRAW_TABS);
}
