...
public class FlyoutPaletteComposite extends Composite {
	 ...
	 */
	public FlyoutPaletteComposite(Composite parent, int style, PaletteViewerProvider pvProvider) {
...
//		}
	...
	private static class DefaultFlyoutPreferences implements FlyoutPreferences {
		...
		// FIXME: Figure out default values
		public int getDockLocation() {
			return prefs.getInt(PALETTE_DOCK_LOCATION, 0);
		}

		public int getPaletteState() {
			return prefs.getInt(PALETTE_STATE, 0);
		}

		public int getPaletteWidth() {
			return prefs.getInt(PALETTE_SIZE, 0);
		}
	...
	private static class DragCursors {
		...
		public static Cursor getCursor(int code) {
			...
			if (cursors[code] == null) {
				...
				switch (code) {
				case LEFT:
					source = SharedImages.get()
							.getImageDescriptor(
									ISharedImages.IMG_OBJS_DND_LEFT_SOURCE);
					mask = SharedImages.get()
							.getImageDescriptor(
