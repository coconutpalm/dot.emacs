...
public/* final */class WorkbenchImages {
	...
	private static final void declareImage(String key, String path, boolean shared) {
		ImageDescriptor desc = ImageDescriptor.createFromFile(WorkbenchImages.class, "../../../../" + path);
	...
	public static void declareImage(String symbolicName, ImageDescriptor descriptor, boolean shared) {
		if (/*Policy.DEBUG_DECLARED_IMAGES*/true) {
			Image image = descriptor.createImage(false);
			if (image == null) {
				throw new IllegalStateException("Image not found in WorkbenchImages.declaredImage().  symbolicName=" + symbolicName //$NON-NLS-1$
	...
	public static ImageDescriptor getWorkbenchImageDescriptor(String relativePath) {
		return ImageDescriptor.createFromFile(WorkbenchImages.class, "../../../../" + relativePath);
	}
}
